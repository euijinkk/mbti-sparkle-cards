...
export const mbtiTests: MBTITest[] = [
  {
    ...
    duration: "12분",
    features: ["깊은 자아 분석", "영혼의 직업", "관계의 진실"],
    icon: "🧠"
  },
  {
    id: "truity",
    name: "Truity TypeFinder",
    description: "과학과 영성이 만나는 지점에서 당신의 진정한 본질을 탐구합니다",
    url: "https://www.truity.com/test/type-finder-personality-test-new",
    duration: "15분",
    features: ["과학적 영감", "맞춤형 깨달음", "운명의 길"],
    icon: "🔬"
  },
  {
    id: "personalitypage",
    name: "Personality Page",
    description: "간결하지만 깊이 있는 자아 발견의 순간, 빠른 깨달음을 원하는 영혼에게",
    url: "https://www.personalitypage.com/html/test.html",
    duration: "5분",
    features: ["순간의 깨달음", "핵심 본질", "간결한 진리"],
    icon: "⚡"
  },
  {
    id: "humanmetrics",
    name: "HumanMetrics",
    description: "융의 깊은 지혜를 바탕으로 한 전통적인 심리 탐구의 신성한 여정",
    url: "https://www.humanmetrics.com/personality/test",
    duration: "10분",
    features: ["고전의 지혜", "무의식 탐구", "정신분석학"],
    icon: "📚"
  },
  {
    id: "keirsey",
    name: "Keirsey Temperament",
    description: "기질의 신비를 풀어내는 독특한 접근법으로 내면의 본성을 해방시킵니다",
    url: "https://keirsey.com/temperament-sorter-ii/",
    duration: "20분",
    features: ["기질의 신비", "리더의 영혼", "협력의 마법"],
    icon: "👥"
  },
  {
    id: "psychologytoday",
    ...
    duration: "8분",
    features: ["전문가의 지혜", "검증된 진실", "과학적 직관"],
    icon: "🏥"
  }
];