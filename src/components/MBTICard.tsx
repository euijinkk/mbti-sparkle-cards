...
export const MBTICard = ({ test }: MBTICardProps) => {
  ...
  return (
    <div className="mbti-card fade-in-mystical group cursor-pointer soul-glow" onClick={handleCardClick}>
      <div className="p-6 relative z-10">
        {/* Floating Particles */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="particle" style={{ top: '20%', animationDelay: '0s' }}></div>
          <div className="particle" style={{ top: '60%', animationDelay: '-3s' }}></div>
        ...
        <div className="space-y-3 mb-8">
          ...
          <div className="space-y-2">
            {test.features.map((feature, index) => (
              <div key={index} className="flex items-center gap-3 text-card-foreground/80">
